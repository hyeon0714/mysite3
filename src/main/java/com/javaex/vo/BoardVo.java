...
public class BoardVo {
	...
	public BoardVo(String title, String content, int hit, String reg_date, String name) {
		super();
		this.title = title;
		this.content = content;
		this.hit = hit;
	...
	public BoardVo(String title, String content, int hit, String reg_date, int user_no, String name) {
		super();
		this.title = title;
		this.content = content;
		this.hit = hit;
